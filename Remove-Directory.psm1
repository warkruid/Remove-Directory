...
.DESCRIPTION
The Remove-Directory function removes files older than a defined amount of time (months, days, hours or minutes) from a given directory
...
Remove-Directory -directory "D:\temp" -interval days -count 3
...
function Remove-Directory {
  <#
    .SYNOPSIS
    Describe purpose of "Remove-Directory" in 1-2 sentences.
    ...
    .EXAMPLE
    Remove-Directory -directory Value -interval Value -count Value
    ...
    The first link is opened by Get-Help -Online Remove-Directory 
